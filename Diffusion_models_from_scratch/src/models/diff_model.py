...
model_path = guided_diffusion_root + "/models/64x64_classifier.pt"
sys.path.append(guided_diffusion_root)
from guided_diffusion import dist_util
from guided_diffusion.script_util import create_classifier

classifier2 = create_classifier(64, False, 128, 4, "32,16,8", True, True, 'attention')
